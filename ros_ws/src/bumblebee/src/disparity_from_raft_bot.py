...
############################ Node to find disparity from bottom stereo (Cam 0 | Cam 1) images using RAFT-Stereo ############################
...
def callback1(data):
    ...
    # Wait for callback0 to finish and the data to be ready
    with lock:
        ...
        print("imgL shape from raft: ", imgL.shape)
        print("imgR shape from raft: ", imgR.shape)
        ...
        def demo(args):
            ...
            with torch.no_grad():
                ...
                for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
                    ...
                    plt.imsave(output_directory / f"disparity_{count}.png", -flow_up.cpu().numpy().squeeze(), cmap='inferno')
        ...
        print(f"Published disparity {count}")
        # rate.sleep()
...
if __name__ == '__main__':
    ...
    # Publisher
    disp_bot_publisher = rospy.Publisher('disp_bot', Float64MultiArray, queue_size=200)
