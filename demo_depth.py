...
#defining file path
path = '/home/frc-ag-1/Desktop/git/vine_pruning/images/2022-11-09-16-57-53.bag/' 
# path = '/home/frc-ag-1/Desktop/git/vine_pruning/images/2022-11-09-17-48-16.bag/'
# DISP_DIR = './demo_output/'
DISP_DIR = "./outputs/2022-11-09-16-57-53.bag/"
...
for i in range(7):
    ...
    disparity = np.load(DISP_DIR  + str(i) +'_rectified.npy')
