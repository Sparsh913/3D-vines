...
cv_file.open('Top_stereoMap.xml', cv2.FileStorage_READ)
...
imgL = cv2.imread('Cam0/Cam 0 viewpoint 0.png')
imgR = cv2.imread('Cam1/Cam 1 viewpoint 0.png')
...
imgL = cv2.imread('rectified_left.jpg')
imgR = cv2.imread('rectified_right.jpg')
...
np.save('disparity_map_Top_Viewpoint_0.npy', disparity_map)
...
output_file = 'pointCloud_Top_Viewpoint_0.ply'
